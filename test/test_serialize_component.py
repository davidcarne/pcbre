...
import unittest
from test.common import saverestore, StorageTestMeta

__author__ = 'davidc'

class test_component_save(unittest.TestCase, metaclass=StorageTestMeta):
    def PARAM_save_pin_names_nets(self, storage_type: StorageType):
        p = Project()
    ...
    def PARAM_test_save_sip(self, storage_type: StorageType):
        p = Project()
        p.stackup.add_layer("test", (1, 1, 1))
    ...
    def PARAM_test_save_dip(self, storage_type: StorageType):
        p = Project()
        p.stackup.add_layer("test", (1, 1, 1))
        d = DIPComponent(p, Point2(64, 54), 33.5, SIDE.Top, p, 12, 512, 640, 1111)
        d.refdes = "UFOO"
    ...
    def PARAM_test_save_smd(self, storage_type: StorageType):
        p = Project()
        p.stackup.add_layer("test", (1, 1, 1))
        d = SMD4Component(p,
    ...
    def PARAM_test_save_passive2(self, storage_type: StorageType):
        p = Project()
        p.stackup.add_layer("test", (1, 1, 1))
