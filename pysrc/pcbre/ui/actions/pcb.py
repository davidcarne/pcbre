...
class StackupSetupDialogAction(QtGui.QAction):
    def __init__(self, window):
        ...
        QtGui.QAction.__init__(self, "Edit Stackup", window, triggered=self.__action)
...
class RebuildConnectivityAction(QtGui.QAction):
    def __init__(self, window):
        ...
        QtGui.QAction.__init__(self, "Rebuild Connectivity", window, triggered=self.__action)
    ...
    def __progress(self, now_v, max):
        ...
        if self.__pd is None:
            ...
            self.__pd = QtGui.QProgressDialog("Rebuilding Connectivity....", "Cancel", 0, max, self.__window)
            self.__pd.show()
...
class LayerViewSetupDialogAction(QtGui.QAction):
    def __init__(self, window):
        self.__window = window
        QtGui.QAction.__init__(self, "Edit Stackup/Imagery pairing", self.__window, triggered=self.__action)
